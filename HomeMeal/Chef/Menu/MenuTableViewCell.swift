...
class MenuTableViewCell: UITableViewCell {
    ...
    let rootView : UIView = {
        let view = UIView()
        view.backgroundColor = AppColors.cloakedNumbersGrayBackgroundColor
        return view
    }()
    ...
    private func setupCellLayout(){
        ...
        lblEndTime.anchor(top: lblStartTime.bottomAnchor, leading: rootViewLeadingAnchor, trailing: rootViewTrailingAnchor, bottom: rootViewBottomAnchor, padding: .init(top: 5, left: 25, bottom: 5, right: 25), size: .init(width: 0, height: 25))
    }
