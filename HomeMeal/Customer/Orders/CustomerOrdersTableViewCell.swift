...
class CustomerOrdersTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        addSubview(rootView)
        rootView.addSubview(lblChefName)
    ...
    private func setupCellLayout(){
        ...
        lblChefName.anchor(top: rootViewTopAnchor, leading: rootViewLeadingAnchor, trailing: rootViewTrailingAnchor, bottom: nil, padding: .init(top: 10, left: 25, bottom: 0, right: 25), size: .init(width: 0, height: 30))
        lblChefName.setCornerRadius(radiusValue: 5.0, makeRoundCorner: false)
        lblChefName.setBorder(borderWidth: 1, borderColor: AppColors.appBlackColor)
        
        lblMealName.anchor(top: lblChefName.bottomAnchor, leading: rootViewLeadingAnchor, trailing: rootViewTrailingAnchor, bottom: nil, padding: .init(top: 5, left: 25, bottom: 0, right: 25), size: .init(width: 0, height: 30))
    ...
    func configureCell(){
        ...
        lblChefName.text = order.orderDetails.chefName
